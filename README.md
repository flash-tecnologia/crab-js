...
generation, `pdf-html-crab-js` for Fulgur-backed HTML-to-PDF conversion, and `kafka-crab-js-otel`
for optional OpenTelemetry instrumentation.
...
| [pdf-html-crab-js](./packages/pdf-html-crab-js) | Native HTML-to-PDF conversion powered by Fulgur                       | [npm package](https://www.npmjs.com/package/pdf-html-crab-js)                                                           |
...
- [PDF HTML package README](./packages/pdf-html-crab-js/README.md): Fulgur HTML-to-PDF API and WASM usage.
